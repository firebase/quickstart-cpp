...
static NSCondition *g_shutdown_complete;  // NOLINT
static NSCondition *g_shutdown_signal;    // NOLINT
static UITextView *g_text_view;           // NOLINT
static UIView *g_parent_view;             // NOLINT
